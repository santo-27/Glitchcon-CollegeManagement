    ...
    return (
        <div>
            {role === "admin" ? ( 
                            ...
                            <form onSubmit={handleSubmit} className="course-form">
                                <div className="course-list flex flex-col gap-4">
                                    {courses.map((course) => (
                                        <label
                                            key={course.id}
                                            className="course-item flex items-center p-4 bg-gray-100 rounded-lg cursor-pointer hover:bg-gray-200 transition"
                                        >
                                            <input
                                                type="radio"
                                                name="course"
                ...
                <h2>You cannot access this page</h2> // This is now correctly placed
            )}
        </div>
    );
}
